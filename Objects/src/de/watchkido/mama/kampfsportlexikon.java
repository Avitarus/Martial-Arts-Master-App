...
public class kampfsportlexikon extends Activity implements B4AActivity{
	public static kampfsportlexikon mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "de.watchkido.mama", "de.watchkido.mama.kampfsportlexikon");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (kampfsportlexikon).");
				p.finish();
			}
		}
		if (!includeTitle) {
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "de.watchkido.mama", "de.watchkido.mama.kampfsportlexikon");
        ...
        if (BA.shellMode) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "de.watchkido.mama.kampfsportlexikon", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (kampfsportlexikon) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (kampfsportlexikon) Resume **");
    ...
    public static Class<?> getObject() {
		return kampfsportlexikon.class;
	}
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (kampfsportlexikon) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
